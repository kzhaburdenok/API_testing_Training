...
def test_Add_new_data():
    ...
    f = open('E:\Automation\API_testing_Training\RequestJson.json', 'r')
    ...
    f = open('E:\Automation\API_testing_Training\TechDetails.json', 'r')
    request_json = json.loads(f.read())  
    ...
    f = open('E:\Automation\API_testing_Training\AddressJson.json', 'r')
    request_json = json.loads(f.read())    
